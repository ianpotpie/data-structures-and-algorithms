...
def smith_waterman(seq1, seq2, scoring_func):
    """
    This finds the local alignment of two sequences according to a the smith-waterman algorithm and a scoring
    function.
...
def main():
    seq1 = sys.argv[1]
    seq2 = sys.argv[2]
    alignment1, alignment2, alignment_score = smith_waterman(seq1, seq2, lambda x, y: 1 if x == y else -1)
